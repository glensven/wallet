...
Genreate `hd-wallet-derive` that supports not only BIP32, BIP39, and BIP44, but
also supports non-standard derivation paths. Additionally, 'hd-wallet-derive' is integrated into Python.

Two coins are working: Ethereum and Bitcoin Testnet.
